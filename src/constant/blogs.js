export const blogContent = [
  {
    ...
    summary: `The Indian Textile we form are governed by rules of behavior-that are
        triggered by our emotionsIndustry is very competitive &always thrives for innovation for its survival.',
        body: 'J.K. Rowling`,
  ...
  {
    id: "emotion-inteligence",
    title: "Managing People through emotion inteligence",
    imagePath: "images/blog/1.jpg",
    summary: `Emotional information plays a critical role in our professional Ii
        since the relationships we form are governed by rules of behavior-that are
        triggered by our emotions`,
    body: "J.K. Rowling",
    pages: `<div class="rs-event-details">
        <div class="container">
            <div class="row">
